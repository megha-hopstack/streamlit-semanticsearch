...
if st.session_state['generated']:
    with response_container:
        for i in range(len(st.session_state['generated'])):
            ...
            with st.chat_message("user", avatar=Image.open('https://raw.githubusercontent.com/megha-hopstack/streamlit-semanticsearch/blob/main/person.png')):
                st.markdown(st.session_state["past"][i])
            with st.chat_message("assistant", avatar=Image.open('https://raw.githubusercontent.com/megha-hopstack/streamlit-semanticsearch/blob/main/hopstacklogo.png')):
